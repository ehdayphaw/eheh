    ...
    <div class="login-page">
        <div class="form">
            ...
            <form  action="login" method="post" th:object="${userBean}" onsubmit="return validateForm();">
            	<input type="text" th:field="*{userName}" placeholder="Enter Your Name" id="name" onblur="validateUsername();" onfocus="clearUsernameError();" />
                <div id="nameError" style="color:red"></div>
                <input type="password" th:field="*{userPass}" placeholder="Enter Your Password" id="password" onblur="validatePassword();" onfocus="clearPasswordError();" />
