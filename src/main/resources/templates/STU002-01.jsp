...
<body>
    <div id="testheader">
        ...
        <div class="col-md-1" >
            <a href="/StudentManagement/logout"><input type="button" class="btn-basic" id="lgnout-button" value="Log Out"></a>
        </div>        
    </div>
    </div>
    ...
    <div id="sub_content">
        <form>
            ...
            <button type="button" class="btn btn-danger  " onclick="location.href = 'STU003.html';">
                Cancel
            </button>
