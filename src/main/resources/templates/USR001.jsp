...
<body>
    ...
    <div id="sub_content">
        ...
        <form id="form"  action="registerbyadmin" method="post" th:object="${userBean}" onsubmit="return validateForm();">	
            ...
            <div class="row mb-4">
                	...
                	<div class="col-md-4">
                    	<select class="form-select" aria-label="Education" id="userRole" th:field="${userBean.userRole}">
						    <option th:value="Admin" th:selected="${userBean.userRole == 'Admin'}">Admin</option>
